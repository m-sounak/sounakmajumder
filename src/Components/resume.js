			...
			<div>
				<div className="contact-body" style={{overflow:'scroll'}} >
					<Grid className="resume-grid" style={{marginBottom:'20px'}}>
						...
						I am currently Candidate Master at Codeforces and 4 star coder at Codechef.
						...
						<a href="https://drive.google.com/file/d/1FVMB7nOBe4ro2xj1WgH4ffv3G5a-W9FO/view?usp=sharing" rel="noopener noreferrer" target="_blank" className="btn anchor">
						<svg width="277" height="62">
							...
							<span><i className="fa fa-address-card" aria-hidden="true"/> Check my resume</span>
						</a>
						...
						<div className="skills">
							...
							<div className="resume-list-item">
								<i className="fa fa-terminal" aria-hidden="true"/> C++ <span className="holder">abc</span>
								<span className="fillCircle">
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
							...
							<div className="resume-list-item">
								<i className="fa fa-terminal" aria-hidden="true"/> JAVA <span className="holder">ab</span>
								<span className="fillCircle">
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
							...
							<div className="resume-list-item">
								<i className="fa fa-terminal" aria-hidden="true"/> nodeJS, express
								<span className="fillCircle">
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
							...
							<div className="resume-list-item">
								<i className="fa fa-terminal" aria-hidden="true"/> PHP <span className="holder">abc</span>
								<span className="fillCircle">
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
							...
							<div className="resume-list-item">
								<i className="fa fa-terminal" aria-hidden="true"/> OpenCV
								<span className="fillCircle">
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
									<i className="fa fa-circle done"></i>
